...
<body>
  ...
  <section data-bs-version="5.1" class="header1 cid-taVzvL9pIB" id="header1-d">
...
<h1 class="mbr-section-title mbr-fonts-style mb-3 display-1 text-primary"><strong>CADASTRO CLIENTE</strong></h1>
<br>
...
<form action="cadastrar_cliente.php" method="post" onSubmit="return valida_campos();">

    <input type="text" name="nome_usu" placeholder="* Nome"  class="form-control" id_usu="nome_usu">
	<br>

	<input type="text" name="email_usu" placeholder="* Email"  class="form-control" id_usu="email_usu">
<br>

	<input type="password" name="senha_usu" placeholder="* Senha"  class="form-control" id_usu="senha_usu">
<br>

    <input type="password" name="senha2_usu" placeholder="* Confirmar Senha"  class="form-control" id="senha2_usu">
  <br>
  <br><input type="submit" value="Cadastrar" class="btn btn-black display-4">
</form>
...
<section data-bs-version="5.1" class="footer3 cid-taVzvPS4Mi mbr-reveal" once="footers" id="footer3-n">
        ...
        <div class="media-container-row align-center mbr-white">
            ...
            <div class="row row-copirayt">
                <p class="mbr-text mb-0 mbr-fonts-style mbr-white align-center display-7">
                    © Copyright 2025 Idea House. Todos os Direitos Reservados.
                </p>
            </div>
        </div>
    </div>
