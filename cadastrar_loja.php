...
$in = mysqli_query($conexao,"insert into usuarios_loja_padrao(nome_usu,email_usu,senha_usu) values ('$nome_usu','$email_usu','$senha_usu')") or die("Erro ao cadastrar");
?>
<div class="msg1 padding20">Cadastro realizado com sucesso!<br>Só um instante..</div>
                <script type="text/javascript">
                setTimeout("window.location='acesso_loja.html';",3000);
                </script>
            </div>
        </div>
    </div>
