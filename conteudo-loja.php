        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true"><li class="nav-item"><a class="nav-link link text-white display-7" href="#top">Home</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link link text-white text-primary display-7" href="index.html#features6-3">Lojas</a>
                    </li><li class="nav-item"><a class="nav-link link text-white display-7" href="index.html#features16-9">Quem Somos</a></li><li class="nav-item"><a class="nav-link link text-white text-primary display-7" href="index.html#contacts3-c">Contato</a></li></ul>
            ...
            <div class="col-12 col-md-10">
                <div class="mbr-section-head align-center mb-4">
                    ...
                    <h3 class="mbr-section-subtitle mb-0 mbr-fonts-style display-4">
                        <strong>Sala <?=$_SESSION['id_usu_sessao'];?></strong>
                    </h3>
                    <h3 class="mbr-section-title mb-0 mbr-fonts-style display-2">
                      <strong>

                  <?=$_SESSION['nome_loja_sessao'];?>
                    ...
                    <div class="card mb-3">
                        <div class="card-header" role="tab" id="headingOne">
                            <a role="button" class="panel-title collapsed" data-toggle="collapse" data-bs-toggle="collapse" data-core="" href="#collapse2_0" aria-expanded="false" aria-controls="collapse2">
                                <h6 class="panel-title-edit mbr-fonts-style mb-0 display-7"><strong>Dados de contato
                                    </strong></h6>
                                <span class="Novidade na área da odontologia como na harmonização facial, o peptídeo botulínico, chegou para agregar o tratamento na harmonização facial. Chamado de “Botox da Pele”, trata-se de uma microinfusão na região facial que proporciona a melhora nas rugas, reduz linhas de expressão, aumenta a firmeza e elasticidade da pele, diminui poros, reduz oleosidade e uniformiza o tom da pele.

Liberado pela Agência Nacional de Vigilância Sanitária (Anvisa), a Clínica de harmonização Sheila Picolo, o procedimento já está

sendo realizado pela responsável técnica e especialista na área de harmonização Sheila Picolo. “Pode ser feito até três sessões o procedimento dura em torno de uma hora”, A técnica consiste em suavizar e remove as rugas finas em áreas difíceis de tratar como em volta dos olhos, uniformiza o tom da pele, além disso proporciona diversos efeitos o que no passado não existia um único medicamento que proporcionasse todos efeitos necessários para uma única intervenção. "></span>
                            </a>
                        </div>
