...
<!--
 ...
 <div class="navbar-buttons mbr-section-btn"><a class="btn btn-warning display-4" href="acesso_adm.html">Entrar</a></div>
            </div>
        </div>
    </nav>
</section>
...
<section data-bs-version="5.1" class="header1 cid-sFCAOqBTxa mbr-parallax-background" id="header1-i">
    ...
    <div class="mbr-overlay" style="opacity: 0.6; background-color: rgb(144, 191, 242);"></div>

    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-lg-8">
                <h1 class="mbr-section-title mbr-fonts-style mb-3 display-1"><strong>PortalMillenium</strong></h1>
                <h2 class="mbr-section-subtitle mbr-fonts-style mb-3 display-2"><strong><?PHP echo 'Até mais '.$_SESSION['nome_usu_sessao'].'!'; ?></strong>
                <br><small><?PHP
                #session_start();
                session_destroy(); # Destruir todas as sessões do navegador
                ?>
                <div class="msg1 padding20">Redirecionando para a página inicial...</div>
