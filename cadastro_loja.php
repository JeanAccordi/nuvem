...
<h1 class="mbr-section-title mbr-fonts-style mb-3 display-1 text-primary"><strong>CADASTRO LOJA</strong></h1>
<br>
...
<form action="cadastrar_loja.php" method="post" onSubmit="return valida_campos();">
